...
if os.getenv('CONFIG_AUTH_LDAP_BIND_DN') and os.getenv('CONFIG_AUTH_LDAP_BIND_PASSWORD'):
    str+='''
AUTH_LDAP_BIND_DN = \''''+os.getenv('CONFIG_AUTH_LDAP_BIND_DN')+'''\'
AUTH_LDAP_BIND_PASSWORD = \''''+os.getenv('CONFIG_AUTH_LDAP_BIND_PASSWORD')+'''\'
'''
